...
export default function WorkspaceTopNav({
  ...
  return (
    <nav
      ...
      className="inline-flex rounded-[6px] border border-[var(--cal2-border)] bg-[var(--cal2-surface-2)] p-0.5"
    >
      {items.map((item) => {
        ...
        const sharedClassName = cn(
          ...
          isActive
            ...
            : "border border-transparent text-[var(--cal2-text-secondary)] hover:bg-[rgba(255,255,255,0.04)] hover:text-[var(--cal2-text-primary)]",
        );
