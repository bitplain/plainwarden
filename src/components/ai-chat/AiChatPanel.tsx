            ...
            <AnimatePresence initial={false} mode="popLayout">
              {messages.map((message) => {
                ...
                return (
                  ...
                  >
                    {assistant ? (
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[var(--ai-border)] bg-[var(--ai-accent-soft)] text-[11px] font-semibold uppercase tracking-[0.14em] text-[var(--ai-text-primary)]">
                        AI
                      </div>
                    ) : null}

                    <div className={`w-full max-w-[40rem] ${assistant ? "min-w-0" : "sm:w-auto"}`}>
                    ...
                    {!assistant ? (
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[var(--ai-border)] bg-white/[0.04] text-[11px] font-semibold uppercase tracking-[0.14em] text-[var(--ai-text-secondary)]">
                        Вы
                      </div>
                    ) : null}
                  </motion.article>
